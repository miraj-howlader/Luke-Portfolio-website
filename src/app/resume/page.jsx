'use client'
import { FaHtml5,FaCss3,FaJs,FaFigma,FaNode, FaReact } from "react-icons/fa";
...
const about = {
  title:"About me",
  description:"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus quis ut nostrum",
info:[
  {
    fieldName:"Name",
...
const experience={
  ...
  title:"My experience",
  description:"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis nam iusto ipsum?",
items:[
  {
          ...
          <div className="min-h-[1200px] min-w-[800px]  ">
              ...
              <div className=" flex flex-col gap-[30px] text-center
               xl:text-left">
                ...
                <p className=" max-w-[600px] text-white/60
                 mx-auto xl:mx-0">{experience.description}</p>
            ...
            <div className=" flex flex-col gap-[30px] text-center
               xl:text-left">
                ...
                <p className=" max-w-[600px] text-white/60
                 mx-auto xl:mx-0">{education.description}</p>
                 <ScrollArea className='h-[400px] '>
                  <ul className="  grid grid-cols-1 lg:grid-cols-2
                   gap-[30px]">
            ...
            <TabsContent value='about' className='w-full
             text-center xl:text-left'>
              <div className=" flex flex-col gap-[30px]">
                ...
                <p className=" max-w-[600px] text-white/60
                 mx-auto xl:mx-0">{about.description}</p>
